...
const commands = {
    ...
    "image" : {"element" : "img", "input" : "textarea", "class" : ["w-full", "block", "mb-2"]},
    "link" : {"element" : "a", "input" : "textarea", "class" : ["text-base", "text-blue-500", "underline", "cursor-pointer", "mb-2", "block"]},
    "paragraph" : {"element" : "p", "input" : "textarea", "class" : ["text-base", "text-gray-800", "mb-2"]}
}

const inputClasses = ["mb-3","w-full", "text-white","block", "bg-transparent", "border", "border-white", "p-3"]
